                ...
                >
                    <form @submit="handleSubmit($event, addAddressToCart)">
                        ...
                        <div class="form-group mb-6 mt-4">
                            <label for="customer_note" class="block mb-2 text-sm font-medium text-gray-900">
                            ...
                            <x-shop::form.control-group.error name="customer_note" />
                        </div>
        ...
        app.component('v-checkout-address-customer', {
            ...
            data() {
                return {
                    ...
                    customer_note: '', // tarih burada tutulacak
                }
            },
            ...
            methods: {
                ...
                addAddressToCart(params, { setErrors }) {
                    let payload = {
                        ...
                        customer_note: this.customer_note, // date alanı
                    };
