...
class OrderController extends Controller
{
    ...
    public function packingSlip($id)
    {
        ...
        //Bununla cart tablosundan 'customer_note' yi alıyoruz...
        $cart = \Webkul\Checkout\Models\Cart::find($order->cart_id ?? null);

        // Burada packing slip PDF veya view oluşturabilirsin
        return view('admin::sales.orders.packing-slip', compact('order', 'cart'));
    }
