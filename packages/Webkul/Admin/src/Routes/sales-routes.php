...
use Webkul\Admin\Http\Controllers\Sales\OrderItemEditController;
...
Route::prefix('sales')->group(function () {
    ...
    Route::controller(OrderItemEditController::class)->prefix('orders')->group(function () {

        // Edit tek bir item
        Route::get('{orderId}/items/{itemId}/edit', 'edit')
            ->name('admin.sales.orders.items.edit');

        // Update tek bir item
        Route::post('{orderId}/items/{itemId}/update', 'update')
            ->name('admin.sales.orders.items.update');

        // Update multiple items
        Route::post('{orderId}/items/update-multiple', 'updateMultiple')
            ->name('admin.sales.orders.items.update-multiple');
    });
    /**
     * Invoices routes.
     */
    ...
    Route::controller(OrderController::class)->prefix('orders')->group(function () {
        ...
        Route::get('{id}/packing-slip', 'packingSlip')->name('admin.sales.orders.packing-slip');
    });
