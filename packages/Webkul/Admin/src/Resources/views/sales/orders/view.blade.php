<x-admin::layouts>
    ...
    <div class="mt-5 flex-wrap items-center justify-between gap-x-1 gap-y-2">
        <div class="flex gap-1.5">
            ...
            <a
                href="{{ route('admin.sales.orders.packing-slip', $order->id) }}"
                class="transparent-button px-1 py-1.5 hover:bg-gray-200 dark:text-white dark:hover:bg-gray-800"
            >
            ...
            @if($firstItem)
                <a href="{{ route('admin.sales.orders.items.edit', [$order->id, $firstItem->id]) }}"
                   class="transparent-button px-1 py-1.5 hover:bg-gray-200 dark:text-white dark:hover:bg-gray-800">
                    <span class="icon-edit text-2xl"></span> Edit
                </a>
            @endif
